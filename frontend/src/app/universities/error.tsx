...
export default function UniversitiesError({
  ...
  useEffect(() => {
    console.error('Universities Directory Error:', error);
  }, [error]);
      ...
      <main className="flex-1 container mx-auto max-w-7xl px-4 py-20 flex items-center justify-center">
        <div className="max-w-md w-full p-8 rounded-3xl bg-card border border-border shadow-xl text-center space-y-5">
          ...
          <div className="space-y-1.5">
            <h2 className="text-xl font-bold text-foreground">Failed to load universities</h2>
            <p className="text-xs text-muted-foreground leading-relaxed">
              We encountered an issue fetching provider directory records.
            </p>
          </div>
