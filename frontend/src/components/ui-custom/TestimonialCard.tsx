  ...
  return (
    <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm relative flex flex-col h-full hover:shadow-lg transition-shadow">
      ...
      <div className="flex items-center gap-4 mt-auto">
        <div className="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center text-blue-600 dark:text-blue-400 font-bold font-display text-lg">
          {initials}
        </div>
        <div>
